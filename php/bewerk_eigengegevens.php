...
$sql1 = 'SELECT COUNT(*) FROM tbl_users WHERE NOT id = :id AND email = :email';
...
$RowCount = $query1->fetch(PDO::FETCH_NUM)[0];
...
header('location: ../index.php?page=inzien_gegevens');
?>